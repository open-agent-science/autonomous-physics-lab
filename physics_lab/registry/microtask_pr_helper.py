    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "",
            "Note: agents do not commit regenerated `tasks/ACTIVE.md` or",
            "`docs/task-views/*.md` from microtask PRs; the `Sync Active Board`",
            "post-merge GitHub Action handles regeneration on `main`.",
            "",
