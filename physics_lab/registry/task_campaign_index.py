...
def build_index(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "purpose": (
            ...
            "Regenerated on demand; not a hand-maintained source of truth."
        ),
...
def render_yaml(index: dict[str, Any]) -> str:
    """Render the index as a YAML document with a do-not-edit header."""
    header = (
        "# Generated by scripts/apl_task_campaign_index.py; do not edit by hand.\n"
        "# Regenerate with: python3 scripts/apl_task_campaign_index.py --write\n"
    )
...
def render_markdown(index: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "Regenerate on demand; not auto-synced.",
        "",
