"""TASK-0476 nuclear isotope-chain leave-family-out audit.
...
DEFAULT_REVIEW_PATH = (
    REPO_ROOT / "docs" / "reviews" / "nuclear-isotope-chain-leave-family-out-audit.md"
)
...
def build_metrics() -> dict[str, Any]:
    ...
    return {
        ...
        "lane": "isotope_chain_leave_family_out_audit",
        "sandbox_only": True,
        "evidence_class": "retrospective_full_known_isotope_chain_leave_family_out_audit",
...
def render_report(metrics: dict[str, Any]) -> str:
    ...
    lines = [
        "# Nuclear Isotope-Chain Leave-Family-Out Audit",
        "",
        ...
        "**Script:** `scripts/run_nuclear_isotope_chain_leave_family_out_audit.py`",
...
def write_agent_run_support_files(metrics: dict[str, Any], run_dir: Path) -> None:
    """Write manifest and companion review files for AGENT-RUN-0048."""
            ...
            "checks": [
                {
                    "name": "task_scope",
                    "status": "PASS",
                    "notes": "TASK-0476 requests isotope-chain transfer diagnostics, not reveal scoring.",
                },
                {
                    "name": "data_boundary",
                    "status": "PASS",
    ...
    limitations = ["# AGENT-RUN-0048 Limitations", ""]
...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument(
        ...
        help="Path for the human-facing review artifact.",
    )
    ...
    if args.review is not None:
        ...
        args.review.write_text(render_report(metrics), encoding="utf-8")
