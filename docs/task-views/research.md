...
- `TASK-0577` - Adopt id-only task reference convention (drop task paths in prose) (`research_infrastructure`, priority `medium`, difficulty `medium`, domain `task_architecture`)
