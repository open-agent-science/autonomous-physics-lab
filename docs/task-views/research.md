...
- `TASK-0576` - Scope task validation: full schema on active, minimal on archive (`research_infrastructure`, priority `medium`, difficulty `medium`, domain `task_architecture`)
