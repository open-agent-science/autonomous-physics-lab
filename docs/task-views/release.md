...
- `TASK-0896` - Package the ThermoML esters/lactones failed-family result as negative memory (`scientific_result_publication`, priority `medium`, difficulty `medium`, domain `thermophysical_property_estimation`)
