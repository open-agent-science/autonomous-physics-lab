...
| --- | --- | --- |
| [Nuclear Mass Surface](./nuclear-mass-surface.md) | Baseline benchmark, sandbox pilots, deterministic factory, frozen prospective registry, no-leakage policy, shell-axis diagnostic-only decision, local-curvature no-leakage falsification, `NMD-0003` factory sprint with zero shortlist, frozen stratified gate, and independent gate replay. | `TASK-0584`, `TASK-0594`, `TASK-0595`, `TASK-0596`, and `TASK-0553`: run bounded residual-feature/control diagnostics under the frozen gate; keep reveal scoring blocked. |
| [Exoplanet Mass-Radius Benchmark](./exoplanet-mass-radius.md) | Pinned catalog snapshot, CK17-style baseline, residual/failure map, compact-radius matched-control diagnostic, null-baseline control panel, target-freeze protocol, reviewer capsule, and closed `EXO-0002` reopen gate. | `TASK-0597`, `TASK-0598`, and `TASK-0599`: preserve closed-lane memory, inspect row-class drift, and define when a third snapshot is worth acquiring. |
| [Quantum Size Effects](./quantum-size-effects.md) | Scaffold, calibration-derived seeds, direct-source triage, source-artifact intake path, synthetic digitization fixture, calibration-consistency scorecard, Norris-Bawendi source-copy handoff, and Kang-Wise inadmissibility blocker exist; measurement-grade baseline remains blocked. | `TASK-0605`: scout one open direct-table source, or proceed with Norris-Bawendi only after a legitimate maintainer source copy. |
...
| [Materials Property Residuals](./materials-property-residuals.md) | `MD-0001`, a pinned Materials Project stable-binary-oxides dataset with 169 rows, independent replay, do-not-promote preflight, and a weak-but-surviving band-gap null-control signal. | `TASK-0600`, `TASK-0601`, `TASK-0602`, and `TASK-0607`: formation-energy controls, split sensitivity, MD-0002 planning, and public-safe evidence packaging. |
