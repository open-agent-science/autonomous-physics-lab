...
| --- | --- | --- |
| [Nuclear Mass Surface](./nuclear-mass-surface.md) | `NMD-0003` frozen stratified gate, negative factory memory, uncertainty-weighted diagnostic, replayable F2 signal, and a promotion decision that requires exactly one component ablation before any promotion route. | `TASK-0625`: run the F2 survival-margin component ablation; keep reveal scoring blocked. |
...
| [Quantum Size Effects](./quantum-size-effects.md) | Scaffold, calibration-derived seeds, direct-source triage, source-artifact intake path, synthetic digitization fixture, Norris-Bawendi handoff, Kang-Wise inadmissibility blocker, and Almeida 2023 promising-but-digitization-required source scout. | `TASK-0630`: package Almeida 2023 source artifact and decide digitization/schema feasibility. |
| [Atomic-Clock Residuals](./atomic-clock-residuals.md) | Beloy pinned rows, real-row loader, covariance policy, Nemitz/Pizzocaro source artifacts, Pizzocaro source-to-row ledger identifying Figure 2a VLBI as the best row surface, and Lange/PTB fallback scout. | `TASK-0627`: freeze Pizzocaro VLBI aggregation/covariance semantics or preserve a precise row blocker. |
| [Materials Property Residuals](./materials-property-residuals.md) | `MD-0001` pinned Materials Project binary-oxide dataset, replayed baseline, formation-energy control survival, split-robust formation-energy signal, split-fragile band gap, and Materials selected as formation-energy-only second Research Factory adapter. | `TASK-0614`, `TASK-0626`, and `TASK-0607`: decide result/dataset route, run bounded formation-energy factory smoke sprint, and package public-safe evidence. |
