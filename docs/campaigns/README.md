...
- **New thermophysical benchmark lane:** Thermophysical Property Residuals starts
  ...
  AGENT_VALIDATED Joback transfer result with explicit esters/lactones
  failed-family memory.
...
| [Thermophysical Property Residuals](./thermophysical-property-residuals.md) | AGENT_VALIDATED ThermoML `Tb` `RESULT-0026` on a 40-row family-stratified fixture, with a frozen Joback baseline, rights boundary, and esters/lactones negative memory. | `TASK-0936` and `TASK-0940`: package failed-family memory and prepare the 80-row source-rights decision packet. |
...
| Materials widenings | `MD-0002` stable ternary oxides are frozen and have AGENT_VALIDATED RESULT-0021 plus scope-control, transfer-negative memory, and Zenodo DOI record-back. | Release-integrity/no-claim verification; future rebuild requires a versioned release reason. |
| [Thermophysical Property Residuals](./thermophysical-property-residuals.md) | Newly active source-pinned benchmark lane with AGENT_VALIDATED ThermoML Tb RESULT-0026 and preserved esters/lactones failed-family memory. | Bounded negative-result packaging plus source-rights decision before expansion; no raw archive vendoring or multi-property broadening. |
