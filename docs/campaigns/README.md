...
| test a new source-gated campaign | [Fresh Physics Data Axes](./fresh-physics-data-axes.md) | Lattice-QCD aggregated consistency has one incubator for an observable dependency/covariance graph; a full campaign opens only after GO. |
...
| [Textbook Formula Audit](./textbook-formula-audit.md) | AGENT_VALIDATED exact-reference `RESULT-0019`, Stellar M-L `RESULT-0022`, FIRAS/Wien `RESULT-0023`, and high-mass transfer `RESULT-0024`; CHARA is alias-gated and the Gaia DR4 reveal contract is armed but value-blind. | Run disjoint CHARA alias and Gaia DR4 field/freeze/leakage gates; no stellar values or metrics. |
...
| --- | --- | --- |
| [Fresh Physics Data Axes](./fresh-physics-data-axes.md) | Atomic and FRB have graduated; Lattice-QCD aggregated consistency is a one-task planning incubator. | Decide whether one observable dependency/covariance graph adds value beyond FLAG; no real rows or world average. |
