...
| help build the next direct-measurement dataset | [Quantum Size Effects](./quantum-size-effects.md) | Almeida 2023 produced six direct InP rows and `RESULT-0029`; Kim-2020 produced repeatable optical x coordinates but failed its frozen two-axis calibration gate, so only a separately reviewed text-reported source route may reopen it. |
...
| work on reusable benchmark datasets | [Materials Property Residuals](./materials-property-residuals.md) | It has `MD-0001`, `MD-0002`, AGENT_VALIDATED `RESULT-0021`, a citable MD-0002 release, and a bounded 172-row OQMD source surface ready for grouped split and value-blind control gates. |
...
| [Quantum Size Effects](./quantum-size-effects.md) | Almeida 2023 direct InP rows, source-scoped sandbox baseline, frozen factual ZnSe rows, AGENT_VALIDATED `RESULT-0029`, and Kim-2020 `UNCERTAINTY_BLOCKED` extraction memory. | Decide whether text-reported CdSe optical peaks form a separate admissible source route; do not weaken or rerun the failed digitization contract. |
...
| [Materials Property Residuals](./materials-property-residuals.md) | `MD-0001`, `MD-0002`, AGENT_VALIDATED `RESULT-0021`, a citable Zenodo DOI, and a hash-pinned 172-row OQMD source surface after conservative MD-0002 overlap exclusions. | Freeze the OQMD grouped split and within-source controls value-blind, then require source replay before metrics. |
| [Textbook Formula Audit](./textbook-formula-audit.md) | Four narrow results are AGENT_VALIDATED; all twelve CHARA rows across six systems passed independent source replay, while Gaia DR4 remains held on same-component luminosity semantics. | Run the frozen-relation CHARA transfer without refitting; do not fill source-limited systems with inferred values. |
