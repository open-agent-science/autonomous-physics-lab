...
| [Nuclear Mass Surface](./nuclear-mass-surface.md) | Baseline benchmark, sandbox pilot, prediction factory, frozen prospective registry, and post-registry scout synthesis | `EXP-0012/RUN-0001`, `AGENT-RUN-0005`, factory reviews, `PRED-0001` through `PRED-0062`, shell-axis stress survival, asymmetry-frontier review evidence, and mid-mass negative scout evidence | stress synthesis, agent-vs-factory comparison, reveal source-readiness, and gated shell-axis target-batch design |
