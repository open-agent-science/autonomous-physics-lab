...
| [Nuclear Mass Surface](./nuclear-mass-surface.md) | Flagship scaffold active, benchmark stack not built yet | campaign guardrails and canonical task queue only | pinned dataset layer, baseline residual benchmark, and holdout protocol |
