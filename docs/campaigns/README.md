...
| [Materials Property Residuals](./materials-property-residuals.md) | `MD-0001` pinned Materials Project binary-oxide dataset, replayed baseline, formation-energy control survival, split-robust formation-energy signal, split-fragile band gap, and validated/frozen `MD-0002` snapshot. | `TASK-0703`: run the MD-0002 formation-energy retest under the frozen control plan. |
