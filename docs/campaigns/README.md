...
- **Default near-term science-output sprint:** FRB pre-T model freeze and
  sealed-registration preparation, Exoplanet `RESULT-0027` Gate-B-safe
  workflow repair, Nuclear point-only reveal governance, and source/readiness
  decisions for Atomic, Quantum, Stellar, Dimensional, and ThermoML expansion.
...
| [Thermophysical Property Residuals](./thermophysical-property-residuals.md) | AGENT_VALIDATED ThermoML `Tb` `RESULT-0026` on a 40-row family-stratified fixture, with a frozen Joback baseline, rights boundary, and AGENT_PUBLISHED esters/lactones negative/control `RESULT-0028`. | Keep expansion source-access and family-count blockers explicit; do not broaden to other properties or rerun Joback as a new result. |
