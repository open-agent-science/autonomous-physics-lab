...
| `RESULT` | `RESULT-0032` - Frozen within-OQMD exact cation-pair baseline fails against the predeclared IUPAC group-pair null | `INVALID` | `n/a` | `replay-needed` | [`results/EXP-0024/RUN-0001/result.yaml`](../results/EXP-0024/RUN-0001/result.yaml) |
...
| `RESULT` | `RESULT-0021` - Materials MD-0002 Formation-Energy Cation-Pair Baseline Benchmark (stable ternary oxides) | `VALID_IN_RANGE` | `independent` | `maintainer-review-needed` | [`results/EXP-0014/RUN-0001/result.yaml`](../results/EXP-0014/RUN-0001/result.yaml) |
...
| `RESULT` | `RESULT-0024` - Stellar M-L High-Mass DEBCat Transfer - frozen RESULT-0022 relation survives stage-matched controls | `VALID_IN_RANGE` | `independent` | `maintainer-review-needed` | [`results/EXP-0017/RUN-0001/result.yaml`](../results/EXP-0017/RUN-0001/result.yaml) |
...
| `RESULT` | `RESULT-0026` - ThermoML Tb bounded family-stratified Joback transfer benchmark | `VALID_IN_RANGE` | `independent` | `maintainer-review-needed` | [`results/EXP-0020/RUN-0001/result.yaml`](../results/EXP-0020/RUN-0001/result.yaml) |
