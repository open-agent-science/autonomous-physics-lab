...
`RESULT-0010` provides a clean falsification. This claim remains `DRAFT`
until the maintainer reviews the scope and wording.

## Scope

- Up-type quarks (u, c, t) and down-type quarks (d, s, b) only.
- PDG 2024 MS-bar running masses at mixed scales (no RG running to common scale).
- Standard Koide formula and phase-modified Q(δ) variant only.
- Does not test GUT-scale masses, quark mixing effects, or non-equal phase spacing.
