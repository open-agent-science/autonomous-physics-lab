# AGENT-RUN-0013 Preflight

**Task:** TASK-0279  
**Lane:** nuclear neutron-rich variant scout  
**Mode:** sandbox-only autonomous research pilot

## Inputs Checked

- `tasks/TASK-0279-run-nuclear-neutron-rich-variant-scout.yaml`
...
1. Generate bounded neutron-rich/asymmetry candidate ideas.
